...
class CollectionLeftSidebar extends Component {
    ...
    //     // const itemsList =await getSearchedProducts(categoryId)
    ...
    render (){
        ...
        return (
            <div>
                {/*SEO Support*/}
                <Helmet>
                    <title>{`GlobalbuyBd | Collection of ${categoryId}`}</title>
                    <meta name="description" content="Multikart – Multipurpose eCommerce React Template is a multi-use React template. It is designed to go well with multi-purpose websites. Multikart Bootstrap 4 Template will help you run multiple businesses." />
                </Helmet>
                {/*SEO Support End */}

                <Breadcrumb title={`Collection/${categoryId}`}/>
                                            ...
                                            <div className="row">
                                                <div className="col-sm-12">
                                                    ...
                                                    <div className="collection-product-wrapper">
                                                        ...
                                                        <ProductListing colSize={this.state.layoutColumns} categoryId/>
