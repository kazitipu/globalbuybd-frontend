...
class Product1688 extends Component {
    ...
    getSingleProduct =async() =>{
        const _EXTERNAL_URL = `https://taobao-1688-api-nodejs.herokuapp.com/singleProduct/${this.props.match.params.id},1688`;
...
export default connect(mapStateToProps, {addToCart, addToCartUnsafe, addToWishlist,fetchSingleProduct,setSearchedProductDetail}) (Product1688);